...
label_names = ["glutamatergic","granule", "medium_spiny", "basket", "fast_spiking", "pyramidal"]

X_train_list = ["glutamatergic_X_train.txt","granule_X_train.txt", "medium_spiny_X_train.txt", "basket_X_train.txt", "fast_spiking_X_train.txt", "pyramidal_X_train.txt"]
